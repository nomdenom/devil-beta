...
void __fastcall town_clear_upper_buf(char *);
void __fastcall town_clear_low_buf(char *);
void __fastcall town_44A643(char *, int);
void __fastcall town_44A6F5(int, int);
